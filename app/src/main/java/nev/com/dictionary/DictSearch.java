...
public class DictSearch {
    ...
    public void buildDict(){
        ...
        fpath.append(Environment.getExternalStorageDirectory().toString()+ "/dictionary");
        File f = new File(fpath.toString());

        dict = new Dictionary(f);
                try{dict.open();}catch (IOException e){e.printStackTrace();created=false;}
    ...
    public boolean exists(){return created;}

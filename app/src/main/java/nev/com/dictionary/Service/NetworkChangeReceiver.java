...
import nev.com.dictionary.DetailDialog;
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if(isConnected(context)){
            ...
            while (cursor.moveToNext()) {
                ...
                serviceIntent.putExtra(DetailDialog.HEADWORD_KEY, word);
            ...
            if(cursor.moveToFirst()) {
                Intent openAppIntent = new Intent(context, MainDictionary.class);
